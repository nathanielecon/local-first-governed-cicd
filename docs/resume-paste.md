...
1. Built a local-first CI/CD platform that separates credential-free GitHub PR validation from Jenkins digest promotion with staging verify, named human approval, append-only evidence, and rollback to the prior verified image.
